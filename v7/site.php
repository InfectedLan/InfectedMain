					...
					echo '<nav id="menu">';
						echo '<ul>';
							echo '<li class="has-sub"><a href="pages/information.html"><span>Informasjon</span></a>';
								...
								echo '</ul>';
							echo '</li>';
							echo '<li><a href="https://tickets.' . $_SERVER['HTTP_HOST'] . '/" target="_blank"><span>Billetter</span></a></li>';
							...
							echo '<li class="last"><a href="https://crew.' . $_SERVER['HTTP_HOST'] . '/" target="_blank"><span>Crew</span></a></li>';
						echo '</ul>';
					echo '</nav>';
				echo '</header>';
				echo '<div id="main">';
