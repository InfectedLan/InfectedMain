...
?>
    ...
    <div id="General_information" class="Background2 preventOverlay">
        ...
        <div style=" padding-top:50px; padding-bottom:50px; min-height:100px; text-align: center;">
...
<?php
    ...
    echo '<div style="z-index:100; position:relative; text-align: center;" class="Banner_Post Background1">';
...
?>
    ...
    <div class="Background2 preventOverlay" style="padding-top:50px; padding-bottom:50px; min-height:100px; text-align: center;">
        <div class="Banner_Info">
